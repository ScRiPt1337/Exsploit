...
n=t
o=!1}if(typeof r=="number")m=function(a1,a2){return function(){return a1(a2)}}(H.xn,r)
...
xL:function(a){throw H.b(new P.hJ(a))},
...
return a},
xl:function(a){if(typeof a=="number")return J.c3.prototype
...
xq:function(a,b){return a==null?b==null:a===b},
...
if(b){t=[c]
C.b.P(t,d)
d=t}return P.qI(P.rx(a,P.bx(J.uH(d,P.xy(),null),!0,null),null))},
...
xx:function(){var t=new W.eQ(document.querySelectorAll(".tff_tool"),[W.U])
...
pP:function pP(){},
po:function po(){},
xD:function(a,b){var t=H.j([],[[P.f,P.c]])
a.B(0,new B.ou(t,b))
...
xM:function(a){if(!!a.$isbW)return a
return new Z.bW(a)},
...
xm:function(a){switch(a){case"0":return P.S(0,0,0,0,0,0)
...
$.qJ=s
return s}},
dH:function(a,b){return D.xI(a,b)},
...
vK:function(a,b,c,d,e,f,g,h){var t=new X.d7(B.xM(a),h,b,g,c,d,e,f)
t.cM(b,c,d,e,f,g,h)
return t},
...
while(true)switch(t){case 0:if(M.xx())throw H.b(P.c0("tool is already running"))
B.vg()
S.q_(null)
r=[P.c]
...
bN:function(a,b,c,d){return N.xw(a,!0,!0,!0)},
xw:function(a,b,c,d){var t=0,s=P.w(P.a1),r,q
...
return s.charCodeAt(0)==0?s:s},
r:function(a,b,c,d,e,f,g,h){return O.xA(a,b,c,d,e,f,!1,h)},
xA:function(a,b,c,d,e,f,g,h){var t=0,s=P.w(null),r,q,p,o
...
O.r(!0,H.j([o],[W.U]),"Page is successfully unfollowed.",!1,!1,!0,!1,"info")
return},
...
O.r(!0,null,"Page unfollow started.",!1,!1,!0,!1,"info")
...
Y.cr()
return}q=a.length
if(q===0){O.r(!0,null,"Page unfollow list is empty.",!1,!1,!0,!1,"err")
Y.cr()
return}t.a=0
new Y.nF(t,a,q,b,r,s).$0()},
...
H.bg(m,"$isrl")
if(m.checked)p.push(m.getAttribute("data-page-id"))}if(p.length===0){O.r(!0,null,"Page unfollow list is empty.",!1,!1,!0,!1,"err")
Y.cr()
return}Y.wi(p,H.bg(t.querySelector("#delay"),"$isd4").value)},
o8:function(a){return Y.wR(a)},
wR:function(a){var t=0,s=P.w(null)
var $async$o8=P.x(function(b,c){if(b===1)return P.t(c,s)
while(true)switch(t){case 0:J.bk(a)
t=2
return P.k(N.bN("unfollow_pages",!0,!0,!0),$async$o8)
case 2:if(c)Y.wS()
return P.u(null,s)}})
...
case 2:r=document
q=H.bg(r.querySelector("#start"),"$isbV");(q&&C.O).dl(q,"click",Y.xP())
J.oH(r.querySelector("#select_all"),"click",Y.xO())
J.oH(r.querySelector("#unselect_all"),"click",Y.xQ())
Y.o0()
return P.u(null,s)}})
...
gH:function(a){return a.message}}
W.jn.prototype={
bx:function(a){return W.xF(a.remove(),null)}}
W.jo.prototype={
gh:function(a){return a.length}}
W.jp.prototype={
gM:function(a){return a.id}}
...
t=$.$get$qd()
if(t.gA(t)){for(s=0;s<262;++s)t.k(0,C.a7[s],W.xo())
for(s=0;s<12;++s)t.k(0,C.v[s],W.xp())}},
...
t=this.a
s=b==null?null:P.bx(new H.aN(b,P.xz(),[H.E(b,0),null]),!0,null)
...
return B.xH(J.V(this.gaZ().c.a,"charset"))},
...
t=H.xJ(t,"/","",0)}}else t="\\\\"+H.d(a.ga1(a))+H.d(t)
t.toString
s=H.bP(t,"/","\\")
...
t=this.a
s=J.an(this.b[t.a])
r="/page/follow_mutator/?page_id="+H.d(P.bJ(C.t,s,C.e,!1))+"&status=false&location=141&dpr=1.5"
q=new XMLHttpRequest()
W.cj(q,"readystatechange",new Y.nG(t,q,s,this.c,this.d,this),!1,W.n)
C.m.dF(q,"POST",r,!0)
...
if(t.readyState===4)if(t.status===200){Y.wh(t,this.c)
if(++this.a.a<this.d)P.ve(U.xm(this.e),this.f,-1)
else{O.r(!0,null,"Process of un-following pages completed.",!0,!0,!0,!1,"succ")
Y.cr()
...
installTearOff(P,"xb",1,0,1,null,["$1"],["xr"],40,0)
installTearOff(P,"xa",1,0,2,null,["$2"],["xq"],41,0)
installTearOff(P,"x9",1,0,1,null,["$1"],["vU"],16,0)
installTearOff(W,"xo",1,0,4,null,["$4"],["w5"],9,0)
installTearOff(W,"xp",1,0,4,null,["$4"],["w6"],9,0)
...
installTearOff(P,"xz",1,0,1,null,["$1"],["qI"],1,0)
installTearOff(P,"xy",1,0,1,null,["$1"],["qH"],31,0)
...
installTearOff(S,"xN",1,0,0,null,["$0"],["es"],5,0)
installTearOff(Y,"xP",1,0,1,null,["$1"],["o8"],2,0)
installTearOff(Y,"xO",1,0,1,null,["$1"],["wK"],2,0)
installTearOff(Y,"xQ",1,0,1,null,["$1"],["wW"],2,0)
...
C.af=new H.da("call")
C.ah=new S.lb("Unfollow multiple / all pages","This tool will allow you to unfollow multiple or all Facebook pages at once.","unfollow_pages","https://www.toolkit-for-fb.com/how-to-unfollow-multiple-all-facebook-pages/","/dart_content/unfollow_p.dart","/html_content/unfollow_p.html","/css_content/unfollow_p.css",null)
C.j=new N.de("false")
C.x=new N.de("true")
C.e=new P.lA(!1)
...
if(typeof dartMainRunner==="function")dartMainRunner(Y.fH,[])
else Y.fH([])})})()
